...
- [Never mark PR ready without permission](feedback_no_final_pr_without_permission.md) — CRITICAL: NEVER run gh pr ready autonomously; gt submit --draft for iteration is OK
